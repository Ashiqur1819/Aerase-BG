...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between mx-4 py-5 lg:mx-60">
      ...
      <button className="bg-zinc-800 flex items-center justify-between gap-4 py-2 px-4 sm:px-8 sm:py-3 cursor-pointer rounded-full text-white hover:bg-zinc-900">
        Get Started{" "}
